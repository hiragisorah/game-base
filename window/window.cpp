...
const bool Window::Initalize(const std::string & caption, const unsigned int & width, const unsigned int & height)
{
	return this->impl_->Initalize(caption, width, height);
}

const bool Window::Run(void)
{
	return this->impl_->Run();
}

const bool Window::Finalize(void)
{
...
void * const Window::get_hwnd(void)
{
